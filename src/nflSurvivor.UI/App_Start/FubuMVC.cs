...
[assembly: WebActivator.PreApplicationStartMethod(typeof(nflSurvivor.UI.App_Start.AppStartFubuMVC), "Start", callAfterGlobalAppStart: true)]

namespace nflSurvivor.UI.App_Start
{
